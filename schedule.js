...
var schedule = {
    [NUMERATOR]: {
        [MONDAY]: {
            ...
            [THIRD]: 'Нормативно-техническая база обеспечения безопасности (л) 120А',
    ...
    [DENOMINATOR]: {
        ...
        [TUESDAY]: {
            [FIRST]: 'Производственная безопасность (л) 120А',
            [SECOND]: 'Нормативно-техническая база обеспечения безопасности (пр) 120А',
        ...
        [FRIDAY]: {
            [FIRST]: 'Производственная санитария и гигиена труда (л/р) 119А',
