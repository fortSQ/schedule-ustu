...
var schedule = {
    [NUMERATOR]: {
        [MONDAY]: {
            [FIRST]: 'Экспертиза условий труда и аттестация персонала (л) 35Г',
            [SECOND]: 'Производственная санитария и гигиена труда (л) 120А',
            [THIRD]: 'Производственная санитария и гигиена труда (л/р) 119А',
            [FOURTH]: 'Производственная безопасность (л/р) 118А',
        },
        [TUESDAY]: {
            [FIRST]: 'Производственная безопасность (л) 120А',
            [SECOND]: 'Бурение скважин (пр) 216Д',
        ...
        [FRIDAY]: {
            ...
            [FOURTH]: 'Нормо-технич. база обеспечения безопасности (л) 120А',
        },
    },
    [DENOMINATOR]: {
        [MONDAY]: {
